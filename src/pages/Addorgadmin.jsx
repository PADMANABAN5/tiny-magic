    ...
    >
      ...
      <style>
        {`
          ...
          .organization-dropdown .dropdown-menu::-webkit-scrollbar {
            width: 5px;
          }
          .organization-dropdown .dropdown-menu::-webkit-scrollbar-thumb {
            background-color: #bbb;
            border-radius: 4px;
          }
          .organization-dropdown .dropdown-menu::-webkit-scrollbar-thumb:hover {
            background-color: #999;
          }

          /* Horizontal scroll support for each item */
